...
module.exports = class WirelessSensor{
	...
	parse(frame){
		...
		if(typeof this[type] == 'function'){
			...
			if(otf_devices.includes(device_type)){
				console.log('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!');
				console.log(frame.data[7]);
				console.log(frame.data[8]);
				console.log(frame.data[9]);
				console.log(frame.data[10]);
				console.log(frame.data[11]);
			...
			if(!is_new){
				console.log('not new');
				console.log(this.sensor_pool[frame.mac].mode);
			...
			if(new_mode){
				console.log('in if new mode');
				console.log(that.sensor_pool[frame.mac]);
	...
	config_send(sensor_mac, data, opts){
		var that = this;
		console.log('inside config_send');
		return new Promise((fulfill, reject) => {
			that.queue.add(() => {
